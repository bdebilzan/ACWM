...
<head>
	...
	<script type="text/javascript" src="RESOURCES/extensions/filter-control/bootstrap-table-filter-control.js"></script>
	<script type="text/javascript" src="RESOURCES/extensions/multiple-search/bootstrap-table-multiple-search.js"></script>
	<script type="text/javascript" src="RESOURCES/extensions/export/bootstrap-table-export.js"></script>
	<script src="RESOURCES/extensions/editable/bootstrap-table-editable.js"></script>
